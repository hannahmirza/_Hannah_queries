...
SELECT
			...
			r.logit,
			CASE
				WHEN r.logit >= 10 THEN 'very high'
				WHEN r.logit >= 8 THEN 'high'
...
SELECT
		  ...
		  l.logit,
		  CASE
		    WHEN l.logit >= 10 THEN 'very high'
		    WHEN l.logit >= 8 THEN 'high'
...
DROP TABLE IF EXISTS prototype_lead_grade_testing;
CREATE TABLE prototype_lead_grade_testing AS
